...
Deletion starts at the ⋮ menu in the Observation's header ([Observation Viewing](observation-viewing.md)), which holds
**Delete** as its only item — a bin icon and red text, marking it as destructive before it is tapped.
