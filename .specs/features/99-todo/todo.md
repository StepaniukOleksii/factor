- on the ObservationListScreen plus buttons on the observation tiles should redirect user to the CreateRecordScreen and
  not to the ObservationDetailsScreen
