 ...
 *
 * `range.end` is the exclusive boundary - a day the user never picked - so it is
 * stepped back before formatting: Jul 15–Jul 18 is stored as
 * `{start: Jul 15 00:00, end: Jul 19 00:00}` and must not display as "Jul 19".
 */
